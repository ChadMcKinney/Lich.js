...
case 5: 
        ...
        for (var i = 0; i < $$[$0-1].length; i++) {
            if ($$[$0-1][i].name == "impdecl" && !atdecs) {
                ...
                throw new Lich.ParseError("import declaration in statement block at line " + $$[$0-1][i].pos.first_line ,$$[$0-1][i].pos,"import declaration in statement block");
            } else {
                atdecs = true;
                decs.push($$[$0-1][i]);
            }
...
case 113:this.$ = [$$[$0]];
break;
case 114:this.$ = new Lich.TyVar($$[$0], this._$);
break;
case 115:this.$ = new Lich.TyCon($$[$0], this._$);
break;
case 116:this.$ = new Lich.TyCon($$[$0], this._$, yy.lexer.previous.qual);
break;
case 117:this.$ = $$[$0];
break;
...
case 133:this.$ = $$[$0];
break;
case 134:this.$ = new Lich.ConsDaCon(this._$);
break;
case 135:this.$ = new Lich.DaCon($$[$0], this._$, true, yy.lexer.previous.qual);
break;
case 136:this.$ = $$[$0];
break;
case 137:this.$ = $$[$0];
...
case 139:this.$ = $$[$0];
break;
case 140:this.$ = new Lich.FunType([$$[$0-2],$$[$0]],this._$);
break;
case 141:this.$ = new Lich.AppType($$[$0-1],$$[$0],this._$);
break;
case 142:this.$ = $$[$0];
break;
case 143:this.$ = $$[$0];

/*  
    This is a modified version of the jison file form JSHC. Thank you much for the hard work of creating a haskell parser in JS:
    https://github.com/evilcandybag/JSHC

    For Lich we've ripped out many parts that aren't useful and added several new kinds of syntax for sequencing etc...
*/
